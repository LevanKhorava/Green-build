      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-gray-400">ტელეფონი</p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-gray-400">ელ. ფოსტა</p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-gray-400">სამუშაო საათები</p>
              <p className="text-gray-200 font-medium">
                ორშ – პარ: 09:00 – 18:00
              </p>
              <p className="text-gray-400 text-sm">შაბ: 10:00 – 15:00</p>
            </div>
          </div>
